...
import { ClearWishlistService } from "../../../Services/Products/Wishlist/clear-wishlist.service";
...
const service = new ClearWishlistService(repository);

class ClearWishlistController {
  static async clear(req: RequestWithCredentials, res: Response): Promise<Response> {
    try {
