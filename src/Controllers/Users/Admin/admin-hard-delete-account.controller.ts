...
import { AdminHardDeleteAccountService } from "../../../Services/Users/Admin/admin-hard-delete-account.service";
...
const service    = new AdminHardDeleteAccountService(repository, logService, logsRepo);

class AdminHardDeleteAccountController {
  static async hardDelete(req: RequestWithCredentials, res: Response): Promise<Response> {
    try {
...
export { AdminHardDeleteAccountController };
