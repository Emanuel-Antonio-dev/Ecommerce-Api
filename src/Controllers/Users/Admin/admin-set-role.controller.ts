...
import { AdminSetRoleService } from "../../../Services/Users/Admin/admin-set-role.service";
...
const service        = new AdminSetRoleService(repository, logService);

class AdminSetRoleController {
  static async set(req: RequestWithCredentials, res: Response): Promise<Response> {
    try {
      ...
      const result = await service.execute(id_account as string, admin_role, admin_id_account, ip_address, system_agent);
