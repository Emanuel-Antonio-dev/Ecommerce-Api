...
import { AdminReactivateAccountService } from "../../../Services/Users/Admin/admin-reactivate-account.service";
...
const service    = new AdminReactivateAccountService(repository, logService);

class AdminReactivateAccountController {
  static async reactivate(req: RequestWithCredentials, res: Response): Promise<Response> {
    try {
...
export { AdminReactivateAccountController };
