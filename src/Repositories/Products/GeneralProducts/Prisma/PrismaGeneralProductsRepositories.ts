...
class PrismaGeneralProductsRepositories implements IGeneralProductsRepositories
{
    ...
    {
        return await this.prisma.products.update({where:{id_product: id_product}, data:{...datas, id_category_fk: datas.id_category_fk, id_brand_fk: datas.id_brand_fk}, select:{images:{where:{url: datas.image_url}}}})    
    }
